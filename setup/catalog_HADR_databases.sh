...
db2 catalog TCPIP NODE srv1 REMOTE 10.0.0.101 SERVER 50000
db2 CATALOG DATABASE sample AS db_srv1 AT NODE srv1
db2 update alternate server for database DB_SRV1  using hostname 10.0.0.101  port 50000

# uncatalog
db2 UNCATALOG DATABASE db_srv1
# db2 uncatalog  NODE srv1
